...
class SupervisedTrainer(object):
    ...
    def _train_epoches(self, data, model, n_epochs, start_epoch, start_step,
        ...
        # TODO add some utils here to show the training result by showing 
        # some examples in the train datasets.
        device = self.device
            ...
            for batch in batch_generator:
                ...
                if step % self.checkpoint_every == 0 or step == total_steps:
                    Checkpoint(model=model,
                               ...
                               input_vocab=data.fields['content'].vocab,
                               output_vocab=data.fields['title'].vocab).save(self.expt_dir)
